...
def get_model_config(Model_Path):
    ...
    print('model config path : ', model_config_json)
...
def eval_retrieval(evalargs):
    ...
    pred_config = PredictConfig(
        ...
        input_names=['localdescs', 'lengths'],
    ...
    for [pcds, lengths, names] in df:  # pcds is a list, batchsize x numpts x 3
        ...
        results = predictor(pcds, lengths)
    ...
    if evalargs.eval_recall:
        evaluator = GlobalDesc_eval(result_savedir='./result_savedir/', desc_dir=save_dir,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='./FCGF_test2')

    # for evaluation
    parser.add_argument('--ModelPath', type=str, help='Model to load (for evaluation)',
                        default='../../models/global/fcgf_1107_18_test2/model-735910.data-00000-of-00001')
    # parser.add_argument('--data_path', type=str, default="../data/oxford_test_global")
    parser.add_argument('--data_path', type=str, default="../../testdata/oxford_test_global_feature/")
    parser.add_argument('--ref_gt_file', type=str, default='oxford_test_global_gt_reference.pickle')
    parser.add_argument('--qry_gt_file', type=str, default='oxford_test_global_gt_query.pickle')
