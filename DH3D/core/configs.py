...
class ConfigFactory(object):
    ...
    def basic_config(self):
        config = {
            ...
            'data_aug': ['Jitter'],
            'sampled_kpnum': 512,
            'data_basedir': '/root/DH3D/traindata/ox_feature2/ox_global',
    ...
    def global_config(self):
        ...
        cfg.global_backbone = 'global_before_assemble_conv1d'
        cfg.global_assemble = 'global_netvald_block_fcgf'
